...
![GitHub](https://img.shields.io/badge/github/:variant/:afonsok/:teste)
![GitHub](https://img.shields.io/badge/github/last-commit/:afonsok/:teste)
![GitHub](https://img.shields.io/badge/github/commit-activity/:interval/:afonsok/:teste)
...
![Git](./images/git-icon.svg) [Git](https://git-scm.com/) ![git](https://img.shields.io/badge/git->=v2.35.1.windows.2-blue)
